...
export default class LinkUI extends Plugin {
	...
	private _createFormView(): LinkFormView & ViewWithCssTransitionDisabler {
		...
		formView.textInputView.fieldView.bind( 'value' ).to( linkCommand, 'text' );
		...
		this.listenTo( formView, 'submit', () => {
			...
			editor.execute( 'link', parsedUrl, text, formView.getDecoratorSwitchesState() );
			this._closeFormView();
		} );
	...
	private _addFormView(): void {
		...
		// Make sure that each time the panel shows up, the URL and Text field remains in sync with the value of
		...
		this.formView!.textInputView.fieldView.element!.value = linkCommand.text || '';
	}
