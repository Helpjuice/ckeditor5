...
import LinkFormView, {
	type LinkFormValidatorCallback,
...
export default class LinkUI extends Plugin {
	 ...
	 */
	public formView: (LinkFormView & ViewWithCssTransitionDisabler) | null =
		null;
...
function findLinkElementAncestor(
	...
	return (
		position
			.getAncestors()
			.find((ancestor): ancestor is ViewAttributeElement =>
				isLinkElement(ancestor)
			) || null
	);
}
