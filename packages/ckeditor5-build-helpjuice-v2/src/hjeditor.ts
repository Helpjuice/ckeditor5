...
const colorPalette = [
	{ color: 'hsl(6, 78%, 74%)', label: 'Peachy Pink' },
	{ color: 'hsl(6, 78%, 66%)', label: 'Light Apricot' },
	{ color: 'hsl(6, 78%, 57%)', label: 'Light Salmon' },
	{ color: 'hsl(6, 59%, 50%)', label: 'Salmon' },
	{ color: 'hsl(6, 59%, 43%)', label: 'Rusty Salmon' },
	{ color: 'hsl(6, 59%, 37%)', label: 'Deep Salmon' },
	{ color: 'hsl(6, 59%, 30%)', label: 'Dark Salmon' },
	{ color: 'hsl(282, 39%, 68%)', label: 'Pale Lavender' },
	{ color: 'hsl(282, 39%, 58%)', label: 'Lavender Gray' },
	{ color: 'hsl(282, 44%, 47%)', label: 'Grayish Purple' },
	{ color: 'hsl(282, 44%, 42%)', label: 'Medium Purple' },
	{ color: 'hsl(282, 44%, 36%)', label: 'Dark Medium Purple' },
	{ color: 'hsl(282, 44%, 30%)', label: 'Dark Purple' },
	{ color: 'hsl(282, 44%, 25%)', label: 'Deep Purple' },
	{ color: 'hsl(204, 70%, 72%)', label: 'Powder Blue' },
	{ color: 'hsl(204, 70%, 63%)', label: 'Sky Blue' },
	{ color: 'hsl(204, 70%, 53%)', label: 'Cornflower Blue' },
	{ color: 'hsl(204, 62%, 47%)', label: 'Steel Blue' },
	{ color: 'hsl(204, 62%, 40%)', label: 'Dark Steel Blue' },
	{ color: 'hsl(204, 62%, 34%)', label: 'Deep Steel Blue' },
	{ color: 'hsl(204, 62%, 28%)', label: 'Navy Blue' },
	{ color: 'hsl(145, 61%, 69%)', label: 'Pale Green' },
	{ color: 'hsl(145, 61%, 59%)', label: 'Light Green' },
	{ color: 'hsl(145, 63%, 49%)', label: 'Mint Green' },
	{ color: 'hsl(145, 63%, 43%)', label: 'Seafoam Green' },
	{ color: 'hsl(145, 63%, 37%)', label: 'Green Gray' },
	{ color: 'hsl(145, 63%, 31%)', label: 'Sage Green' },
	{ color: 'hsl(145, 63%, 25%)', label: 'Dark Sage Green' },
	{ color: 'hsl(48, 89%, 70%)', label: 'Pale Yellow' },
	{ color: 'hsl(48, 89%, 60%)', label: 'Light Yellow' },
	{ color: 'hsl(48, 89%, 50%)', label: 'Lemon Yellow' },
	{ color: 'hsl(48, 88%, 44%)', label: 'Mustard Yellow' },
	{ color: 'hsl(48, 88%, 38%)', label: 'Goldenrod' },
	{ color: 'hsl(48, 88%, 32%)', label: 'Dark Goldenrod' },
	{ color: 'hsl(48, 88%, 26%)', label: 'Bronze' },
	{ color: 'hsl(24, 71%, 65%)', label: 'Pale Orange' },
	{ color: 'hsl(24, 71%, 53%)', label: 'Light Orange' },
	{ color: 'hsl(24, 100%, 41%)', label: 'Orange' },
	{ color: 'hsl(24, 100%, 36%)', label: 'Dark Orange' },
	{ color: 'hsl(24, 100%, 31%)', label: 'Deep Orange' },
	{ color: 'hsl(24, 100%, 26%)', label: 'Burnt Orange' },
	{ color: 'hsl(24, 100%, 22%)', label: 'Rust' },
	{ color: 'hsl(210, 12%, 86%)', label: 'Light Gray' },
	{ color: 'hsl(210, 12%, 71%)', label: 'Silver' },
	{ color: 'hsl(210, 12%, 57%)', label: 'Gray' },
	{ color: 'hsl(210, 15%, 43%)', label: 'Dark Gray' },
	{ color: 'hsl(210, 29%, 18%)', label: 'Charcoal Gray' },
	{ color: 'hsl(210, 29%, 16%)', label: 'Graphite' },
	{ color: 'hsl(210, 29%, 13%)', label: 'Black' }
];
